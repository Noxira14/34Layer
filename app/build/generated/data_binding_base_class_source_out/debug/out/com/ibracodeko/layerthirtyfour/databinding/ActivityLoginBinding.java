...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ScrollView rootView, @NonNull MaterialButton btnLogin,
      @NonNull MaterialButton btnRegister, @NonNull MaterialButton btnThemeToggle,
      @NonNull TextInputEditText etPassword, @NonNull TextInputEditText etUsername,
      @NonNull FrameLayout loadingOverlay, @NonNull LottieAnimationView loginAnimation,
      @NonNull LinearLayout loginForm, @NonNull TextInputLayout tilPassword,
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((ScrollView) rootView, btnLogin, btnRegister, btnThemeToggle,
          etPassword, etUsername, loadingOverlay, loginAnimation, loginForm, tilPassword,
          tilUsername, tvSubtitle, tvTitle);
    }
