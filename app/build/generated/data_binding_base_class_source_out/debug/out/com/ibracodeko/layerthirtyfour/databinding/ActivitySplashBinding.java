...
public final class ActivitySplashBinding implements ViewBinding {
  ...
  private ActivitySplashBinding(@NonNull RelativeLayout rootView,
      @NonNull LottieAnimationView splashAnimation, @NonNull TextView tvAppName,
  ...
  public static ActivitySplashBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.splashAnimation;
      LottieAnimationView splashAnimation = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivitySplashBinding((RelativeLayout) rootView, splashAnimation, tvAppName,
          tvSubtitle);
    }
