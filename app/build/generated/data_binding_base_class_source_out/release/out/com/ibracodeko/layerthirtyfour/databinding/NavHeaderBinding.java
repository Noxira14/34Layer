...
public final class NavHeaderBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView navUserType;

  @NonNull
  public final TextView navUsername;

  private NavHeaderBinding(@NonNull LinearLayout rootView, @NonNull TextView navUserType,
      @NonNull TextView navUsername) {
    this.rootView = rootView;
    this.navUserType = navUserType;
  ...
  public static NavHeaderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.navUserType;
      TextView navUserType = ViewBindings.findChildViewById(rootView, id);
      if (navUserType == null) {
        break missingId;
      }
      ...
      return new NavHeaderBinding((LinearLayout) rootView, navUserType, navUsername);
    }
